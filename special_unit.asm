...
ClassName    	db "WinClass",  	; The name of our Window class
AppName		db "Mian Ali Ahmed", 0		; The name of our main window
...
WndProc proc hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
	...
	LOCAL	hdc:HDC
	LOCAL  	hEdit:HANDLE
    LOCAL  	hButton:HANDLE
    LOCAL  	hhhButton:HANDLE
...
WindowCreate:
    ...
    push    100                      ; x position
    push    WS_CHILD or WS_VISIBLE or BS_PUSHBUTTON ; Window style
    push    OFFSET Button2Title      ; Window name
    push    OFFSET ButtonClassName  ; Class name
    push    0                       ; Extended window style
    call    CreateWindowExA

	mov     hhhButton, eax            ; Save the handle to the button
...
CommandHandler:
    mov     eax, wParam
    and     eax, 0FFFFh
    cmp     eax, 1002               ; Check if the button was clicked
    jne     NotButtonClick
	...
	push    ebx                    ; Size of the buffer
	push    eax
	push    hEdit                   ; Handle to the text box
	call    GetWindowText
    ...
    ; Display the text length for debugging
    push    MB_OK
    push    eax
    push    OFFSET AppName
    push    NULL
    ...
    ; Save text to file
	; First we create a file then we save data to it
    ...
    test    ecx, ecx                ; Check if the write was successful
